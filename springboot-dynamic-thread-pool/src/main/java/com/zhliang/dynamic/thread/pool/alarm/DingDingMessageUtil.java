...
import com.zhliang.dynamic.thread.pool.service.Message;
import com.zhliang.dynamic.thread.pool.service.MessageInfo;
...
public class DingDingMessageUtil {
    ...
    public static void sendTextMessage(String accessToken, String secret, String msg) {
        try {
            ...
            String url =
                    "https://oapi.dingtalk.com/robot/send?access_token=" + accessToken + "&timestamp=" + timestamp +
                            "&sign=" + sign;
